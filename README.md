...
Arianee Protocol is a collection of Ethereum Smart Contracts to emit, track, and manage SmartAssets representing valuable asset.

It's based on ERC-721 (https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md)

You can see it in action on : (https://demo.arianee.org/demo)


## Largely inspired by OpenZeppelin Solidity
